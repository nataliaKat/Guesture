...
VALUES ('luxury@gmail.com', 'Luxury', 'Ροδόπης 4, Κομοτηνή', '2565241236', 'Ανδρέας Γεωργίου', 'Διακοσμημένα με απαράμιλλο στυλ και αισθητική, αυτές οι πολυτελείς bungalow σουίτες βρίσκονται σε προνομιακή θέση, λίγα μέτρα από τη θάλασσα, ανάμεσα στους εξωτικούς καταπράσινους κήπους με τους φοίνικες. Από τις βεράντες τους θα απολαύσετε τη συναρπαστική εικόνα του Κρητικού πελάγους.', 35.50, 50.00, 75.50, 100.00, "https://i2.wp.com/itravelling.gr/wp-content/uploads/2019/08/Patriarca_AriaHotels_1.jpg?resize=1140%2C700&ssl=1"),
	   ('marysrooms@yahoo.com', 'Marys Rooms', 'Κολοκοτρώνη 40, Βόλος', '2152365236', 'Ελένη Παπαδοπούλου', 'Executive δωμάτια με μεγάλους χώρους, πολυτελή επίπλωση που αποτελείται από μοναδικά κομμάτια και δροσερά ιβουάρ υφάσματα που φέρουν την υπογραφή διάσημων σχεδιαστών.', 30.00, 45.50, 60.00, 85.50, "https://www.capesounio.com/assets/media/PICTURES/Cape-Sounio-Resort/At-a-glance/Posts/01-seaside-dining-cape-sounio-30320.jpg"),
       ('acropolisv@gmail.com', 'Acropolis View Hotel', 'Ανδριανού 50, Πλάκα', '2194526325', 'Γιώργος Λινός', 'Μια ξεχωριστή πρόταση διαμονής, με επιπλέον ανέσεις ειδικά για οικογένειες με παιδιά ή παρέες φίλων που επιζητούν το καλύτερο για τις διακοπές τους.', 50.00, 75.50, 100.00, 130.00, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSnZyIZM4HWe-GkpeTUcuAZmVuHuuIWQJJUQg&usqp=CAU"),
       ...
       ('sweethome@yahoo.com', 'Sweet Home Hotel', 'Κανάρη 56, Θησείο', '1254563289', 'Chris Green', 'Κομψά δωμάτια με εκλεπτυσμένη ατμόσφαιρα, διακόσμηση σε ιβουάρ, χρυσές & και αργυρές αποχρώσεις και δάπεδα από ξύλο ή πέτρα.', 40.00, 55.50, 70.00, 100.00, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSGqIP-ZOpHOLxxcNuldZ2ol1AquRmwBz3Bgw&usqp=CAU"),
       ('iraklion@gmail.com', 'Iraklion Hotel', 'Καλοκαιρινού 128, Ηράκλειο', '2563245639', 'Σωτήρης Φανταράκης', 'Εμπνευσμένες από τις παραδοσιακές διώροφες Κρητικές κατοικίες, τα δωμάτια μας ξεχωρίζουν για το επιβλητικό στυλ τους και το μοντέρνο ρουστίκ design που κυριαρχεί στους εσωτερικούς και εξωτερικούς χώρους.', 30.50, 40.50, 51.50, 65.00, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT5T7W8bIylI6_RBfgeO2E9e-kB-rcKYacWXA&usqp=CAU"),
       ('portoven@gmail.com', 'Porto Veneziano Hotel', 'Ακτή Ενώσεως και Γλαύκου, Χανιά', '2569685632', 'Μαρία Κωσταντάκη', 'Ανανεωμένα & ευρύχωρα δωμάτια σχεδιασμένα ειδικά για οικογένειες, αγκαλιασμένα από πολύχρωμους λουλουδόκηπους και εξωτική διακόσμηση. Μεγάλοι χώροι για επιπλέον άνεση, με μεγάλες βεράντες και κήπους. Υπαίθριοι χώροι με υπέροχη διακόσμηση. Κι ακόμα περισσότερα!', 37.50, 45.00, 52.50, 65.00, "https://www.cretapalace.com/assets/media/PICTURES/CRETA%20PALACE/GUESTROOMS/Deluxe-Family-Guestroom/01-creta-palace-deluxe-family-guestroom-12814.jpg");
