        ...
        <%@page import="java.util.List;" %>
            <%@ page import="model.*" %>
                <%@ page import="dao.*" %>
                    ...
                    <% User user=(User)session.getAttribute("userObj2020"); %>
                                        ...
                                        <table id="example"
                                            ...
                                            <tbody style="text-align: center;">
                                                <% ReservationDao rd=new ReservationDao(); AgencyDao ad=new AgencyDao();
                                                    List<Reservation> reservations = rd.getAll(user.getUsername);
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <button type="button" class="btn btn-info"
                                                                    data-toggle="modal" data-target="#members-modal"><i
                                                                        class="fas fa-users"></i></button>
                                                            </td>

                                                            <td>
                                                                <button type="button" class="btn btn-info"
                                                                    data-toggle="modal" data-target="#services-modal"><i
                                                                        class="fas fa-utensils"></i></button>

                                                            </td>
                                                            <td><button type="button" class="btn btn-warning"
                                                                    data-target="#modal-edit" data-res="32153"
                                                                    data-ar_date="2021-05-25" data-ar_time="morning"
