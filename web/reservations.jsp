                    ...
                    <div class="mb-3 mt-3">
                        <table id="example"
                            ...
                            <tbody style="text-align: center;">
                                <% ReservationDao rd=new ReservationDao(); AgencyDao ad=new AgencyDao();
                                    ...
                                    for (int i = 0; i < reservations.size(); i++) { %>
                                        ...
                                        <tr>
                                            ...
                                            <td><button type="button" class="btn btn-warning" data-target="#modal-edit"
                                                    data-res="32153" data-ar_date="2021-05-25" data-ar_time="morning"
                                                    data-dep_date="2021-05-30" data-dep_time="evening"
                            ...
                            <div class="modal-body">
                                <form role="form" method="POST" action="edit.jsp">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input id="ar_date" type="date" class="form-control input-lg"
                                                name="ar_date">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input id="ar_time" type="text" class="form-control input-lg"
                                                name="ar_time">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input id="dep_date" type="date" class="form-control input-lg"
                                                name="dep_date">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input id="dep_time" type="text" class="form-control input-lg"
                                                name="dep_time">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <input type="submit" class="ml-auto my-button" style="margin-right: 10px;"
                                            value="Edit">
                                    </div>
                                </form>
                            </div><!-- /.modal-content -->
