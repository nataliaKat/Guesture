    ...
    <body id="reservation">
        <header>
            ...
            <nav class="navbar navbar-expand-md navbar-light  custom-nav">
                <a class="navbar-brand" href="index.html"><img class="logo" src="../web/images/logo_blue_nav.png"
                        alt="logo"></a>
        ...
        <main class="container">
            <div class="row">
                <a href="new_reservation.html"><button location.href="" class="my-button"><i class="fas fa-plus"></i>
                        New
                ...
                <table id="example"
                    ...
                    <tbody style="text-align: center;">
                        ...
                        <tr>
                            ...
                            <td><button type="button" class="btn btn-info"><i class="fas fa-users"></i></button>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>-</td>
                            <td><button type="button" class="btn btn-success"><i class="fas fa-door-open"></i></button>
                            </td>
                            <td><button type="button" class="btn btn-danger"><i class="fas fa-trash-alt"></i></button>
                            </td>
                        </tr>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form role="form" method="POST" action="edit.jsp">
                            ...
                            <div class="row">
                                <input type="submit" class="ml-auto my-button" style="margin-right: 10px;" value="Edit">
                            </div>
                        </form>
                    </div><!-- /.modal-content -->
                </div><!-- /.modal-dialog -->
