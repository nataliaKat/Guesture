...
<head>
    ...
    <title>Guesture | Review of Agency</title>
    <!-- Bootstrap 4 -->
    ...
    <nav class="navbar navbar-expand-md navbar-light custom-nav">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="#"><i class="fas fa-user"></i> Dream Agency</a>
                </li>
                <li class="nav-item">
...
<main class="container">
    ...
    <div class="page-header" style="text-align: center;">
        <h1>Review Of Agency</h1>
    </div>

    <div class="page-header" style="text-align: center;">
        <h3>Please complete the review for the hotel</h3>
    </div>
            ...
            <div class="col-12 col-md-6">
                <form>
                    <div class="form-group">
                        <label for="comments"><b>Comments Of Review</b></label>
                        <textarea class="form-control" id="comments" rows="4">Reception staff was very friendly, rooms were not very clean.</textarea>
                    </div>

                    <hr>

                    <div class="form-group">
                        <label for="exampleFormControlSelect1" ><b>Please choose a reservation: </b></label>

                        <select class="form-control" id="exampleFormControlSelect1">
                            <option>ID: 70085</option>
                            <option>ID: 32569</option>
                            <option>ID: 85924</option>
                            <option>ID: 00526</option>
                        </select>
                    </div>
                ...
                <div class="form-group">
                    <div >
                        <button type="submit" class="blueButton">Submit your review</button>
                    </div>
                </div>
            </div>
        </div>
