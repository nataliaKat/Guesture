...
<head>
    ...
    <title>Dream Hotel | Statistics</title>
    <!-- Bootstrap 4 -->
    ...
    <script type="text/javascript">
        ...
        function drawMaterial() {
            ...
            data.addColumn('number', 'Completeness 2019');
            data.addColumn('number', 'Completeness 2020');
            ...
            var options = {
                title: 'Comfort Evaluation 2019 - 2020',
                colors: ['#e0440e','#353745'],
                hAxis: {
                    title: 'Month',
                },
                vAxis: {
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="chart.html">Statistics<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
...
<main>
    <form>
        <div class="col-sm-6 col-lg-2" style="margin-left: 20pt; padding-bottom: 2%;">
            <select id="criterion" class="form-control">
                <option selected>Completeness</option>
                <option>Members per agency</option>
